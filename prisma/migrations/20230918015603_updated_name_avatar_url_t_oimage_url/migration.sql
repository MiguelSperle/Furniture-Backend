/*
  ...
  - You are about to drop the column `avatarUrl` on the `UserGithub` table. All the data in the column will be lost.
  - Added the required column `imageUrl` to the `UserGithub` table without a default value. This is not possible if the table is not empty.
